        ...
        <header class="main-header">
            <!--  logo  -->
            <div class="logo-holder"><a href="index.html"><img src="{{ asset('theme/images/logo.png') }}"
                        alt=""></a>
            </div>
            <!-- logo end  -->
            <!-- nav-button-wrap-->
            ...
            <div class="add-list_wrap">
                <a href="dashboard-add-listing.html" class="add-list color-bg"><i class="fal fa-plus"></i> <span>Add
                        Listing</span></a>
            </div>
            <!--  add new  btn end -->
            <!--  header-opt_btn -->
                    ...
                    <ul class="no-list-style">
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="dark/index.html" target="_blank">Dark Demo</a></li>
                            </ul>
                            <!--second level end-->
                        </li>
                        <li>
                                    ...
                                    <ul class="no-list-style">
                                        <li>
                                            <div class="widget-posts-img"><a href="listing-single.html"><img
                                                        src="{{ asset('theme/images/all/small/1.jpg') }}" alt=""></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="widget-posts-img"><a href="listing-single.html"><img
                                                        src="{{ asset('theme/images/all/small/2.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="widget-posts-descr">
                                        ...
                                        <li>
                                            <div class="widget-posts-img"><a href="listing-single.html"><img
                                                        src="{{ asset('theme/images/all/small/3.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="widget-posts-descr">
                                ...
                                <div class="header-modal-container scrollbar-inner fl-wrap" data-simplebar>
                                    ...
                                    <div class="widget-posts  fl-wrap">
                                        <ul class="no-list-style">
                                            <li>
                                                <div class="widget-posts-img"><a href="listing-single.html"><img
                                                            src="{{ asset('theme/images/all/small/4.jpg') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="widget-posts-descr">
                                            ...
                                            <li>
                                                <div class="widget-posts-img"><a href="listing-single.html"><img
                                                            src="{{ asset('theme/images/all/small/5.jpg') }}"
                                                            alt=""></a>
                                                </div>
                                                <div class="widget-posts-descr">
